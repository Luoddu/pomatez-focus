...
基于 [zidoro/pomatez](https://github.com/zidoro/pomatez) 的 **v1.11.0**，固定提交 **c2727800c6272573590911e9ee81637b89e55d5f**，MIT 许可证。保留原始 LICENSE、Git 历史和上游贡献者归属。保留上游原始资产；当前番茄品牌图标由本分支生成；不使用滴答清单的商标或专有图像资源。
