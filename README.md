...
**当前版本：0.1.0-preview.1 · Windows x64 预览版。** 桌面计时与飞书记录同步已验证；飞书看板的图表需要按说明在飞书界面配置。尚未完成独立用户体验验收，不作为稳定版发布。

<img src="docs/images/desktop.png" alt="Pomatez Focus 桌面界面，使用演示任务" width="420" />
